/**
 * ARCHITECTURAL: Bootstrap loader for ImageAnnotation studio view
 *
 ...
 * ImageAnnotationStudioView → YourXBlockStudioView
 */
function ImageAnnotationStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load ImageAnnotation studio view:', error);

/**
 * ARCHITECTURAL: Bootstrap loader for ImageAnnotation student view
 *
 ...
 * ImageAnnotationStudentView → YourXBlockStudentView
 */
function ImageAnnotationStudentView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load ImageAnnotation student view:', error);

/**
 * ARCHITECTURAL: Bootstrap loader for ImageCommentary studio view
 *
 ...
 * ImageCommentaryStudioView → YourXBlockStudioView
 */
function ImageCommentaryStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load ImageCommentary studio view:', error);

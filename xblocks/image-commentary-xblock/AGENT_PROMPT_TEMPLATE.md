...
cp -r react-xblock-template/ image-commentary/
cd image-commentary
```

Replace `image-commentary` with your XBlock's kebab-case name (e.g., `text-card-xblock`).
...
|-------------|--------------|---------|
| `ImageCommentary` | PascalCase name | `TextCard` |
| `image_commentary` | snake_case name | `text_card` |
| `image-commentary` | kebab-case name | `text-card-xblock` |

**Files to update**:
- [ ] `image_commentary/image_commentary.py` → Rename file and update placeholders
- [ ] `image_commentary/static/student.js` → Update function names
- [ ] `image_commentary/static/studio.js` → Update function names
...
##### A. Python XBlock Class (`image_commentary/image_commentary.py`)
...
This builds both student-ui and studio-ui bundles to `image_commentary/public/`.

**Expected output**:
```
✓ built in 2.5s
image_commentary/public/student-ui.js
image_commentary/public/studio-ui.js
image_commentary/public/student-ui.css (if you have styles)
```
...
- [ ] All placeholders replaced (ImageCommentary, image_commentary, image-commentary)

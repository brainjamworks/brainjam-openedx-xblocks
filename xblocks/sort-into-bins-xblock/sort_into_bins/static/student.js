/**
 * ARCHITECTURAL: Bootstrap loader for SortIntoBins student view
 *
 ...
 * SortIntoBinsStudentView → YourXBlockStudentView
 */
function SortIntoBinsStudentView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load SortIntoBins student view:', error);

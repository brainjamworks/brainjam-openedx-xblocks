/**
 * ARCHITECTURAL: Bootstrap loader for SortIntoBins studio view
 *
 ...
 * SortIntoBinsStudioView → YourXBlockStudioView
 */
function SortIntoBinsStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load SortIntoBins studio view:', error);

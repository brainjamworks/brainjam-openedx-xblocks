...
cp -r react-xblock-template/ timeline-presentation-xblock/
cd timeline-presentation-xblock
```

Replace `timeline-presentation-xblock` with your XBlock's kebab-case name (e.g., `text-card-xblock`).
...
|-------------|--------------|---------|
| `TimelinePresentation` | PascalCase name | `TextCard` |
| `timeline_presentation` | snake_case name | `text_card` |
| `timeline-presentation-xblock` | kebab-case name | `text-card-xblock` |

**Files to update**:
- [ ] `timeline_presentation/timeline_presentation.py` → Rename file and update placeholders
- [ ] `timeline_presentation/static/student.js` → Update function names
- [ ] `timeline_presentation/static/studio.js` → Update function names
...
##### A. Python XBlock Class (`timeline_presentation/timeline_presentation.py`)
...
This builds both student-ui and studio-ui bundles to `timeline_presentation/public/`.

**Expected output**:
```
✓ built in 2.5s
timeline_presentation/public/student-ui.js
timeline_presentation/public/studio-ui.js
timeline_presentation/public/student-ui.css (if you have styles)
```
...
- [ ] All placeholders replaced (TimelinePresentation, timeline_presentation, timeline-presentation-xblock)

...
export default defineConfig(() => {
  ...
  let lib = 'student-ui';
  let libName = 'TimelinePresentationBlock';

  if (process.env.COMPONENT === 'studio-ui') {
    lib = 'studio-ui';
    libName = 'TimelinePresentationEditor';
  }
  ...
  return {
    ...
    build: {
      ...
      // IMPLEMENTATION: Update path if you renamed timeline_presentation
      outDir: '../timeline_presentation/public',

/**
 * ARCHITECTURAL: Bootstrap loader for DragDropMatching studio view
 *
 ...
 * DragDropMatchingStudioView → YourXBlockStudioView
 */
function DragDropMatchingStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load DragDropMatching studio view:', error);

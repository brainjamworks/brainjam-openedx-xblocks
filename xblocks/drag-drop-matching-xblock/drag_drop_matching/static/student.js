/**
 * ARCHITECTURAL: Bootstrap loader for DragDropMatching student view
 *
 ...
 * DragDropMatchingStudentView → YourXBlockStudentView
 */
function DragDropMatchingStudentView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load DragDropMatching student view:', error);

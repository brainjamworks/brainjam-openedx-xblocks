...
export default defineConfig(() => {
  ...
  let lib = 'student-ui';
  let libName = 'DragDropMatchingBlock';

  if (process.env.COMPONENT === 'studio-ui') {
    lib = 'studio-ui';
    libName = 'DragDropMatchingEditor';
  }
  ...
  return {
    ...
    build: {
      ...
      // IMPLEMENTATION: Update path if you renamed drag_drop_matching
      outDir: '../drag_drop_matching/public',

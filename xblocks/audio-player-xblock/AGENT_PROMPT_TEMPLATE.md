...
|-------------|--------------|---------|
| `AudioPlayer` | PascalCase name | `TextCard` |
| `audio_player` | snake_case name | `text_card` |
| `{xblock-name}` | kebab-case name | `text-card-xblock` |

**Files to update**:
- [ ] `audio_player/audio_player.py` → Rename file and update placeholders
- [ ] `audio_player/static/student.js` → Update function names
- [ ] `audio_player/static/studio.js` → Update function names
...
##### A. Python XBlock Class (`audio_player/audio_player.py`)
...
This builds both student-ui and studio-ui bundles to `audio_player/public/`.

**Expected output**:
```
✓ built in 2.5s
audio_player/public/student-ui.js
audio_player/public/studio-ui.js
audio_player/public/student-ui.css (if you have styles)
```
...
- [ ] All placeholders replaced (AudioPlayer, audio_player, {xblock-name})

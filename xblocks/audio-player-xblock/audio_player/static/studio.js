/**
 * ARCHITECTURAL: Bootstrap loader for AudioPlayer studio view
 *
 ...
 * AudioPlayerStudioView → YourXBlockStudioView
 */
function AudioPlayerStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load AudioPlayer studio view:', error);

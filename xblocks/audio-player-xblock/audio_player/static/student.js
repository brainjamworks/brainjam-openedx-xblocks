/**
 * ARCHITECTURAL: Bootstrap loader for AudioPlayer student view
 *
 ...
 * AudioPlayerStudentView → YourXBlockStudentView
 */
function AudioPlayerStudentView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load AudioPlayer student view:', error);

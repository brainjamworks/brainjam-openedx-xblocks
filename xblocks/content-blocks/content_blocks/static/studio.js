/**
 * ARCHITECTURAL: Bootstrap loader for Content Blocks studio view
 *
 ...
 * ContentBlocks StudioView → YourXBlockStudioView
 */
function ContentBlocksStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load Content Blocks studio view:', error);

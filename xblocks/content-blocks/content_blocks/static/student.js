/**
 * ARCHITECTURAL: Bootstrap loader for Content Blocks student view
 *
 ...
 * ContentBlocks StudentView → YourXBlockStudentView
 */
function ContentBlocksStudentView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load Content Blocks student view:', error);

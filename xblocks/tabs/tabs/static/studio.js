/**
 * ARCHITECTURAL: Bootstrap loader for Tabs studio view
 *
 ...
 * Tabs StudioView → YourXBlockStudioView
 */
function TabsStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load Tabs studio view:', error);

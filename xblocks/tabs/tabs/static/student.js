/**
 * ARCHITECTURAL: Bootstrap loader for Tabs student view
 *
 ...
 * Tabs StudentView → YourXBlockStudentView
 */
function TabsStudentView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load Tabs student view:', error);

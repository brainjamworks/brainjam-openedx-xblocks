/**
 * ARCHITECTURAL: Bootstrap loader for {XBlockName} student view
 *
 ...
 * {XBlockName}StudentView → YourXBlockStudentView
 */
function {XBlockName}StudentView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load {XBlockName} student view:', error);

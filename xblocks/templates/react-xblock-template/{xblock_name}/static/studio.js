/**
 * ARCHITECTURAL: Bootstrap loader for {XBlockName} studio view
 *
 ...
 * {XBlockName}StudioView → YourXBlockStudioView
 */
function {XBlockName}StudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load {XBlockName} studio view:', error);

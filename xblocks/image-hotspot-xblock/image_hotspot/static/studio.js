/**
 * ARCHITECTURAL: Bootstrap loader for ImageHotspot studio view
 *
 ...
 * ImageHotspotStudioView → YourXBlockStudioView
 */
function ImageHotspotStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load ImageHotspot studio view:', error);

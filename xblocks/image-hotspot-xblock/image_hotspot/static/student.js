/**
 * ARCHITECTURAL: Bootstrap loader for ImageHotspot student view
 *
 ...
 * ImageHotspotStudentView → YourXBlockStudentView
 */
function ImageHotspotStudentView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load ImageHotspot student view:', error);

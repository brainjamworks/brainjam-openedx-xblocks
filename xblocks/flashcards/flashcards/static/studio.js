/**
 * ARCHITECTURAL: Bootstrap loader for Flashcards studio view
 *
 ...
 * Flashcards StudioView → YourXBlockStudioView
 */
function FlashcardsStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load Flashcards studio view:', error);

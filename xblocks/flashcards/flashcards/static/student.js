/**
 * ARCHITECTURAL: Bootstrap loader for Flashcards student view
 *
 ...
 * Flashcards StudentView → YourXBlockStudentView
 */
function FlashcardsStudentView(runtime, element, data) {
  (async () => {
    try {
      ...
      // Pass DOM element and data from Python (matches xblock-accordion pattern)
      // Note: runtime is available but not needed for basic Paragon Icon usage
      ...
      console.error('Failed to load Flashcards student view:', error);

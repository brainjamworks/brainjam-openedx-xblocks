/**
 * ARCHITECTURAL: Bootstrap loader for Accordion studio view
 *
 ...
 * Accordion StudioView → YourXBlockStudioView
 */
function AccordionStudioView(runtime, element, data) {
  (async () => {
    try {
      ...
      console.error('Failed to load Accordion studio view:', error);
